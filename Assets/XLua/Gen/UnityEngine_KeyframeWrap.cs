...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineKeyframeWrap 
    {
        ...
        static int __CreateInstanceNew(RealStatePtr L)
        {
			...
			try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				if(LuaAPI.lua_gettop(L) == 2 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
				{
				...
				if(LuaAPI.lua_gettop(L) == 4 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4))
				{
					float _time = (float)LuaAPI.lua_tonumber(L, 1);
					float _value = (float)LuaAPI.lua_tonumber(L, 2);
					float _inTangent = (float)LuaAPI.lua_tonumber(L, 3);
					float _outTangent = (float)LuaAPI.lua_tonumber(L, 4);
				...
				if(LuaAPI.lua_gettop(L) == 6 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5) && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 6))
				{
					float _time = (float)LuaAPI.lua_tonumber(L, 1);
					float _value = (float)LuaAPI.lua_tonumber(L, 2);
					float _inTangent = (float)LuaAPI.lua_tonumber(L, 3);
					float _outTangent = (float)LuaAPI.lua_tonumber(L, 4);
					float _inWeight = (float)LuaAPI.lua_tonumber(L, 5);
					float _outWeight = (float)LuaAPI.lua_tonumber(L, 6);
