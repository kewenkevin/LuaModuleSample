...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineAnimationCurveWrap 
    {
        ...
        static int __CreateInstanceNew(RealStatePtr L)
        {
			...
			try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				if(LuaAPI.lua_gettop(L) >= 0 && (LuaTypes.LUA_TNONE == LuaAPI.lua_type(L, 1) || translator.Assignable<UnityEngine.Keyframe>(L, 1)))
				{
					UnityEngine.Keyframe[] _keys = translator.GetParams<UnityEngine.Keyframe>(L, 1);
