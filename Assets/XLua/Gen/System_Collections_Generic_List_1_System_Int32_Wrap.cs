    ...
    public class SystemCollectionsGenericList_1_SystemInt32_Wrap 
    {
        ...
        static int __CreateInstanceNew(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1 && translator.Assignable<System.Collections.Generic.IEnumerable<int>>(L, 1))
				{
					System.Collections.Generic.IEnumerable<int> _collection = (System.Collections.Generic.IEnumerable<int>)translator.GetObject(L, 1, typeof(System.Collections.Generic.IEnumerable<int>));
