...
namespace XLua.CSObjectWrap
{
    ...
    public class NDUINDUINDSliderWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(ND.UI.NDUI.NDSlider);
			Utils.BeginObjectRegister(type, L, translator, 0, 13, 13, 13);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "tweenDuration", _g_get_tweenDuration);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "tweenDuration", _s_set_tweenDuration);
        ...
        {
            return LuaAPI.luaL_error(L, "ND.UI.NDUI.NDSlider does not have a constructor!");
        }
        ...
        static int _m_SetValueWithoutNotify(RealStatePtr L)
        {
		    try {
                ...
                ND.UI.NDUI.NDSlider gen_to_be_invoked = (ND.UI.NDUI.NDSlider)translator.FastGetCSObj(L, 1);
        ...
        static int _m_SetDirection(RealStatePtr L)
        {
		    try {
                ...
                {
                    ND.UI.NDUI.NDSlider.Direction _direction;translator.Get(L, 2, out _direction);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_tweenDuration(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                ND.UI.NDUI.NDSlider gen_to_be_invoked = (ND.UI.NDUI.NDSlider)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushnumber(L, gen_to_be_invoked.tweenDuration);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_tweenDuration(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                ND.UI.NDUI.NDSlider gen_to_be_invoked = (ND.UI.NDUI.NDSlider)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.tweenDuration = (float)LuaAPI.lua_tonumber(L, 2);
        ...
        static int _s_set_onTweenComplete(RealStatePtr L)
        {
		    try {
                ...
                ND.UI.NDUI.NDSlider gen_to_be_invoked = (ND.UI.NDUI.NDSlider)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.onTweenComplete = (ND.UI.NDUI.NDSlider.TweenCompleteEvent)translator.GetObject(L, 2, typeof(ND.UI.NDUI.NDSlider.TweenCompleteEvent));
        ...
        static int _s_set_direction(RealStatePtr L)
        {
		    try {
                ...
                ND.UI.NDUI.NDSlider gen_to_be_invoked = (ND.UI.NDUI.NDSlider)translator.FastGetCSObj(L, 1);
                ND.UI.NDUI.NDSlider.Direction gen_value;translator.Get(L, 2, out gen_value);
        ...
        static int _s_set_onValueChanged(RealStatePtr L)
        {
		    try {
                ...
                ND.UI.NDUI.NDSlider gen_to_be_invoked = (ND.UI.NDUI.NDSlider)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.onValueChanged = (ND.UI.NDUI.NDSlider.SliderEvent)translator.GetObject(L, 2, typeof(ND.UI.NDUI.NDSlider.SliderEvent));
