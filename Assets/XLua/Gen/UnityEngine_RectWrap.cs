    ...
    public class UnityEngineRectWrap 
    {
        ...
        static int __CreateInstanceNew(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<UnityEngine.Vector2>(L, 1) && translator.Assignable<UnityEngine.Vector2>(L, 2))
				{
				...
				if(LuaAPI.lua_gettop(L) == 1 && translator.Assignable<UnityEngine.Rect>(L, 1))
				{
					UnityEngine.Rect _source;translator.Get(L, 1, out _source);
