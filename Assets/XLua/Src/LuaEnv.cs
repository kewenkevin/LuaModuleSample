...
namespace XLua
{
    ...
    public class LuaEnv : IDisposable
    {
        ...
        public static Action<string, string> warnHandler;
        public static Action<string, string> logErrorHandler;
        ...
        public LuaEnv()
        {
...
#endif
            {
                ...
                LuaAPI.lua_pushstdcallcfunction(rawL, StaticLuaCallbacks.Warn);
                if (0 != LuaAPI.xlua_setglobal(rawL, "warn"))
                {
                    throw new Exception("call xlua_setglobal fail!");
                }
                
                LuaAPI.lua_pushstdcallcfunction(rawL, StaticLuaCallbacks.LogError);
                if (0 != LuaAPI.xlua_setglobal(rawL, "logError"))
                {
                    throw new Exception("call xlua_setglobal fail!");
                }
#endif
