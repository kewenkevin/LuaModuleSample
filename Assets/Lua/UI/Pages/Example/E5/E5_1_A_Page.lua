...
---@class E5_1_A_Page : UIPageBase
local E5_1_A_Page = class("E5_1_A_Page", UIPageBase)

---@see UIPageBase#observerDataStore
---observerDataStore 监控模块数仓数据变化，这里注册响应接口
function E5_1_A_Page:observerDataStore()
    return {
    }
end
--endregion
...
---onCloseClick
function E5_1_A_Page:onCloseClick(value)
    self:closeMe()
end

--regionAutoBind 导出控件代码自动生成，请勿手动修改
function E5_1_A_Page:initAutoBind(gameObject)
    ---@type UIExpansion
...
function E5_1_A_Page:BindCommonFunction()
...
-----OnClick_E_Button()
function E5_1_A_Page:OnClick_E_Button()
    self:closeMe()
end
return E5_1_A_Page
