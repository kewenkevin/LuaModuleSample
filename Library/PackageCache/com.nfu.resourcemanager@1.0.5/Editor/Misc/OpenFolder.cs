...
namespace ND.Managers.ResourceMgr.Editor
{
    ...
    public static class OpenFolder
    {
        ...
        /// 打开 Data Path 文件夹。
        /// </summary>
        [MenuItem(EditorUtilityx.OpenFolderMenuPrefix + "Data Path", false, 10)]
        ...
        /// </summary>
        [MenuItem(EditorUtilityx.OpenFolderMenuPrefix + "Persistent Data Path", false, 11)]
        ...
        /// </summary>
        [MenuItem(EditorUtilityx.OpenFolderMenuPrefix + "Streaming Assets Path", false, 12)]
        ...
        /// </summary>
        [MenuItem(EditorUtilityx.OpenFolderMenuPrefix + "Temporary Cache Path", false, 13)]
