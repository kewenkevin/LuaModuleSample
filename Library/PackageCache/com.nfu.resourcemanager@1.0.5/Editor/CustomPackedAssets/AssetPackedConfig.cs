...
// 
//     File Name           :        AssetPackedConfig.cs
// 
//     Programmer          :        Wei Wei (Battle Mage Gandalf)
// 
//     Start Date          :        04/14/2021
// 
//     Last Update         :        04/14/2021 13:35 [Wei]
// 
...
{
    public class AssetPackedConfig
    {
        public string assetPath;

        public AssetPackedConfig(string assetPath)
        {
            this.assetPath = assetPath;
        }

        public static AssetPackedConfig Create(string assetPath)
        {
            return new AssetPackedConfig(assetPath);
        }
