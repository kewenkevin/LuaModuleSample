...
// 
//     File Name           :        IAssetPackListDataProvider.cs
// 
//     Programmer          :        Wei Wei (Battle Mage Gandalf)
// 
//     Start Date          :        04/14/2021
// 
//     Last Update         :        04/14/2021 13:36 [Wei]
// 
...
{
    public interface IAssetPackListDataProvider
    {
        string Tag { get; }
        event GameFrameworkAction<int, int> OnLoadingAsset;
        event GameFrameworkAction OnLoadCompleted;
        bool LoadConfig(ref SortedDictionary<string, AssetPackedConfig> data);
        bool SaveConfig(ref SortedDictionary<string, AssetPackedConfig> data);
    }
}