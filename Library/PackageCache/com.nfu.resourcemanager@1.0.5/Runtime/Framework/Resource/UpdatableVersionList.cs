...
namespace ND.Managers.ResourceMgr.Framework.Resource
{
    ...
    public partial struct UpdatableVersionList
    {
        ...
        private readonly string m_variantPrefixUrl;
        ...
        public UpdatableVersionList(string applicableGameVersion, int internalResourceVersion, Asset[] assets, Resource[] resources, FileSystem[] fileSystems, ResourceGroup[] resourceGroups,string variantPrefixUrl)
        {
            m_IsValid = true;
            ...
            m_variantPrefixUrl = variantPrefixUrl;
        }
