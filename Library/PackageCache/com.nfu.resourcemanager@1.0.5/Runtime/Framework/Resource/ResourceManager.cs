...
namespace ND.Managers.ResourceMgr.Framework.Resource
{
    ...
    {
        public const string RemoteVersionListFileName = "RemoteVersionList.dat";
        public const string LocalVersionListFileName = "LocalVersionList.dat";
        ...
        private Dictionary<string, List<string>> m_ResourceAssets;
        ...
        public ResourceManager()
        {
            ...
            m_variantPrefixUrl = string.Empty;
        ...
        public IObjectPool<ResourceLoader.AssetObject> AssetPool => m_ResourceLoader.AssetPool;
        public IObjectPool<ResourceLoader.ResourceObject> ResourcePool => m_ResourceLoader.ResourcePool;
        ...
        /// 当前资源使用的变体前缀
        /// </summary>
        public string VariantPrefixUrl
        {
            get
            {
                return m_variantPrefixUrl;
            }
        }
        ...
        public ResourceUpdateMode UpdateCheckMode
        {
            get
            {
                return m_UpdateCheckMode;
            }
            set
            {
                m_UpdateCheckMode = value;
            }
        }
        ...
        public string GetResourceName(string assetName)
        {
            ...
            return assetInfo.ResourceName.Name;
        }
        ...
        public string GetResourceFullName(string assetName)
        {
            ...
            return assetInfo.ResourceName.FullName;
        }

        public string GetResourceFileName(string assetName)
        {
            assetName = FixName(assetName);
            m_ResourceLoader.CheckAsset(ref assetName, out var resourceInfo, out var deps);
            if (resourceInfo == null)
                return null;
            return resourceInfo.UseFileSystem ? resourceInfo.FileSystemName : resourceInfo.ResourceName.FullName;
        }
        ...
        public string GetResourcePath(string assetName)
        {
            ...
            if (resourceInfo == null)
                return null;
            return Utility.Path.GetRegularPath(Path.Combine(resourceInfo.StorageInReadOnly ? m_ReadOnlyPath : m_ReadWritePath, resourceInfo.UseFileSystem ? resourceInfo.FileSystemName : resourceInfo.ResourceName.FullName));
        }
        ...
        /// <summary>
        /// 使用可更新模式并检查版本资源列表。m_InitResourcesCompleteCallback
        /// </summary>
        ...
        public CheckVersionListResult CheckVersionList(int latestInternalResourceVersion, string latestApplicableGameVersion)
        {
            ...
            return m_VersionListProcessor.CheckVersionList(latestInternalResourceVersion, latestApplicableGameVersion);
        }
        ...
        public HasAssetResult HasAsset(string assetName)
        {
            ...
            return m_ResourceLoader.HasAsset(FixName(assetName));
        }
        ...
        public void LoadAssetRapid(string assetName, LoadAssetCallbacks loadAssetCallbacks)
        {
            ...
            m_ResourceLoader.LoadAsset(assetName, null, Constant.DefaultPriority, loadAssetCallbacks, null, true);
        }
        ...
        public void LoadAssetRapid(string assetName, Type assetType, LoadAssetCallbacks loadAssetCallbacks)
        {
            ...
            m_ResourceLoader.LoadAsset(assetName, assetType, Constant.DefaultPriority, loadAssetCallbacks, null, true);
        }
        ...
        public void LoadAssetRapid(string assetName, int priority, LoadAssetCallbacks loadAssetCallbacks)
        {
            ...
            m_ResourceLoader.LoadAsset(assetName, null, priority, loadAssetCallbacks, null, true);
        }
        ...
        public void LoadAssetRapid(string assetName, LoadAssetCallbacks loadAssetCallbacks, object userData)
        {
            ...
            m_ResourceLoader.LoadAsset(assetName, null, Constant.DefaultPriority, loadAssetCallbacks, userData, true);
        }
        ...
        public void LoadAssetRapid(string assetName, Type assetType, int priority, LoadAssetCallbacks loadAssetCallbacks)
        {
            ...
            m_ResourceLoader.LoadAsset(assetName, assetType, priority, loadAssetCallbacks, null, true);
        }
        ...
        public void LoadAssetRapid(string assetName, Type assetType, LoadAssetCallbacks loadAssetCallbacks, object userData)
        {
            ...
            m_ResourceLoader.LoadAsset(assetName, assetType, Constant.DefaultPriority, loadAssetCallbacks, userData, true);
        }
        ...
        public void LoadAssetRapid(string assetName, int priority, LoadAssetCallbacks loadAssetCallbacks, object userData)
        {
            ...
            m_ResourceLoader.LoadAsset(assetName, null, priority, loadAssetCallbacks, userData, true);
        }
        ...
        public void LoadAssetRapid(string assetName, Type assetType, int priority, LoadAssetCallbacks loadAssetCallbacks, object userData)
        {
            ...
            m_ResourceLoader.LoadAsset(assetName, assetType, priority, loadAssetCallbacks, userData, true);
        }
        ...
        {
            return m_ResourceLoader.LoadAssetImmediate(assetName, assetType);
        }
        ...
        public void UnloadAsset(string assetName, Type assetType = null)
        {
            ...
            if (!Initializated)
                return;
            m_ResourceLoader.UnloadAsset(assetName, assetType);
        }

        /// <summary>
        /// 获取同包的所有精灵 用以支持TexturePacker
        /// 获取图集Sprite时，<see cref="ResLoader.Add2Load(string, Res.ResLoadCompleteCallBack)"/> 不要传 AssetType
        /// </summary>
        ...
        public object[] GetPackageSubAsset(object asset)
        {
            ...
            if (m_ResourceLoader != null)
            {
                var assetObject = m_ResourceLoader.PeekAssetObject(asset);

#if GTA_SUPPORT
                //loader:Add2Load(path,typeof(Sprite))，不能能获取 Sprite SubAssets
                if (assetObject.subAssets.Length == 0)
                {
                    var sprite = asset as Sprite;
                    if (sprite)
                    {
                        assetObject = m_ResourceLoader.PeekAssetObject(sprite.texture);
                        if (assetObject != null)
                            return assetObject.subAssets;
                    }
                }
#endif
                return assetObject.subAssets;
        ...
        {
            resourceName = FixName(resourceName);
            if (m_ResourceAssets.ContainsKey(resourceName))
            {
                return m_ResourceAssets[resourceName].ToArray();
            }
            else
            {
                return new string[0];
        ...
        private AssetInfo GetAssetInfo(string assetName)
        {
            ...
            if (m_AssetInfos == null)
            {
                Debug.LogError($"{nameof(ResourceManager) } not initalized. AssetInfos null");
                return null;
            }

            if (!Initializated)
            {
                Debug.LogError($"{nameof(ResourceManager) } not initalized");
                return null;
            }

            AssetInfo assetInfo = null;
            if (m_AssetInfos.TryGetValue(TranslateToVariant(assetName), out assetInfo))
            {
                return assetInfo;
            }

            Debug.LogError("not found asset name:  " + assetName + " > " + TranslateToVariant(assetName));
            // if (m_AssetInfos.TryGetValue(FixName(string.Format("{0}{1}/{2}",VariantPrefixUrl,CurrentVariant,assetName)) , out assetInfo))
            // {
            //     return assetInfo;
            // }
        ...
        public string TranslateToVariant(string assetName)
        {
            if (m_AssetInfos.ContainsKey(assetName))
                return assetName;
            else
                return FixName(string.Format("{0}{1}/{2}", VariantPrefixUrl, CurrentVariant, assetName));
        }
        ...
        private void OnCheckerResourceCheckComplete(int movedCount, int removedCount, int updateCount, long updateTotalLength, long updateTotalZipLength)
        {
            ...
            Log.Info($"Check resource complete. update: {updateCount}, delete: {removedCount},move: {movedCount}, bytes: {updateTotalLength}, bytes zip: {updateTotalZipLength}");
