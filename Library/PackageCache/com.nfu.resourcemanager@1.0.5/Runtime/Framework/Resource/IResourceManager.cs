...
namespace ND.Managers.ResourceMgr.Framework.Resource
{
    ...
    public interface IResourceManager
    {
        ...
        /// 
        /// </summary>
        ResourceUpdateMode UpdateCheckMode
        {
            get;
            set;
        }
        ...
        bool Initializated { get; set; }

        IObjectPool<ResourceManager.ResourceLoader.AssetObject> AssetPool { get; }

        IObjectPool<ResourceManager.ResourceLoader.ResourceObject> ResourcePool { get; }
        ...
        CheckVersionListResult CheckVersionList(int latestInternalResourceVersion, string latestApplicableGameVersion);
        ...
        string GetResourceFullName(string assetName);

        string GetResourceFileName(string assetName);
        ...
        UnityEngine.Object LoadAssetImmediate(string assetName, Type assetType = null);
        ...
        /// 卸载资源
        /// </summary>
        void UnloadAsset(string assetName, Type assetType = null);
        ...
        /// </summary>
        /// <param name="resourceName">资源resourceName</param>
        /// <returns></returns>
        string[] GetResourceAllAssets(string resourceName);
        ...
        /// <returns></returns>
        object[] GetPackageSubAsset(object asset);
         ...
         /// <param name="assetName">要加载资源的名称。</param>
         /// <param name="loadAssetCallbacks">加载资源回调函数集。</param>
         void LoadAssetRapid(string assetName, LoadAssetCallbacks loadAssetCallbacks);
        ...
        /// <param name="assetType">要加载资源的类型。</param>
        /// <param name="loadAssetCallbacks">加载资源回调函数集。</param>
        void LoadAssetRapid(string assetName, Type assetType, LoadAssetCallbacks loadAssetCallbacks);
        ...
        /// <param name="priority">加载资源的优先级。</param>
        /// <param name="loadAssetCallbacks">加载资源回调函数集。</param>
        void LoadAssetRapid(string assetName, int priority, LoadAssetCallbacks loadAssetCallbacks);
        ...
        /// <param name="loadAssetCallbacks">加载资源回调函数集。</param>
        /// <param name="userData">用户自定义数据。</param>
        void LoadAssetRapid(string assetName, LoadAssetCallbacks loadAssetCallbacks, object userData);
        ...
        /// <param name="priority">加载资源的优先级。</param>
        /// <param name="loadAssetCallbacks">加载资源回调函数集。</param>
        void LoadAssetRapid(string assetName, Type assetType, int priority,
        ...
        /// <param name="loadAssetCallbacks">加载资源回调函数集。</param>
        /// <param name="userData">用户自定义数据。</param>
        void LoadAssetRapid(string assetName, Type assetType, int priority, LoadAssetCallbacks loadAssetCallbacks,
            object userData);
