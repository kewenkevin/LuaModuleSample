...
namespace ND.Managers.ResourceMgr.Framework.Resource
{
    ...
    public partial struct PackageVersionList
    {
        ...
        public PackageVersionList(string applicableGameVersion, int internalResourceVersion, Asset[] assets, Resource[] resources, FileSystem[] fileSystems, ResourceGroup[] resourceGroups,string variantPrefixUrl)
        {
            m_IsValid = true;
