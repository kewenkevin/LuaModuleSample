    ...
    public sealed partial class ResourceManager : GameFrameworkModule, IResourceManager
    {
        ...
        private sealed partial class ResourceUpdater
        {
            ...
            public void Update(float elapseSeconds, float realElapseSeconds)
            {
                ...
                if (m_UpdateWaitingInfo.Count > 0)
                {
                    if (m_DownloadManager.FreeAgentCount > 0)
                    {
                        ...
                        //服务端始终小写路径
                        resourceFullNameWithCrc32 = resourceFullNameWithCrc32.ToLower();
            ...
            public void CheckResourceComplete(bool needGenerateReadWriteVersionList)
            {
                ...
                {
                    Runtime.Log.Info("CheckResourceComplete needGenerateReadWriteVersionList");
            ...
            private bool ApplyResource(ApplyInfo applyInfo)
            {
                ...
                try
                {
                    ...
                    {
                        m_CurrentGenerateReadWriteVersionListLength = 0;
                        Runtime.Log.Info("ReadWriteVersionListLength done");
                        GenerateReadWriteVersionList();
                        return true;
                    }
            ...
            {
                Runtime.Log.Info("GenerateReadWriteVersionList");
            ...
            private void OnDownloadSuccess(object sender, DownloadSuccessEventArgs e)
            {
                ...
                {
                    Runtime.Log.Info("Update Download completed");
                    m_CurrentGenerateReadWriteVersionListLength = 0;
                    GenerateReadWriteVersionList();
                }
