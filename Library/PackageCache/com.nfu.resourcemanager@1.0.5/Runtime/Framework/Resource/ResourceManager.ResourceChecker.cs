    ...
    public sealed partial class ResourceManager : GameFrameworkModule, IResourceManager
    {
        ...
        private sealed partial class ResourceChecker
        {
            ...
            public void CheckResources(string currentVariant, bool ignoreOtherVariant)
            {
                ...
                Log.Info($"Check Resource variant: {currentVariant}, ignoreOtherVariant: {ignoreOtherVariant}");
            ...
            private void OnLoadUpdatableVersionListSuccess(string fileUri, byte[] bytes, float duration, object userData)
            {
                ...
                Log.Info($"Remote {RemoteVersionListFileName} load success, {fileUri}");
                ...
                try
                {
                    ...
                    m_ResourceManager.m_variantPrefixUrl = versionList.VariantPrefixUrl;
                    m_ResourceManager.m_InternalResourceVersion = versionList.InternalResourceVersion;
                    m_ResourceManager.m_ResourceAssets = new Dictionary<string, List<string>>(resources.Length, StringComparer.Ordinal);
                    ...
                    foreach (UpdatableVersionList.Resource resource in resources)
                    {
                        ...
                        m_ResourceManager.m_ResourceAssets.Add(resource.Name,list);
                    }
            ...
            {
                Log.Info($"ReadOnly {LocalVersionListFileName} load success, {fileUri}");
            ...
            {
                Log.Info($"ReadWrite {LocalVersionListFileName} load success, {fileUri}");
