...
namespace ND.Managers.ResourceMgr.Framework.Resource
{
    ...
    public interface ILoadResourceAgentHelper
    {
        ...
        void ReadFile(string fullPath , bool rapidly);
        ...
        void ReadFile(IFileSystem fileSystem, string name , bool rapidly);

        /// <summary>
        /// 通过加载资源代理辅助器开始异步读取资源二进制流。
        /// </summary>
        /// <param name="fullPath">要加载资源的完整路径名。</param>
        void ReadBytes(string fullPath,bool rapidly);
        ...
        /// <param name="fileSystem">要加载资源的文件系统。</param>
        /// <param name="name">要加载资源的名称。</param>
        void ReadBytes(IFileSystem fileSystem, string name,bool rapidly);

        /// <summary>
        /// 通过加载资源代理辅助器开始异步将资源二进制流转换为加载对象。
        /// </summary>
        /// <param name="bytes">要加载资源的二进制流。</param>
        void ParseBytes(byte[] bytes,bool rapidly);
        ...
        void LoadAsset(object resource, string resourceName,string assetName, Type assetType, bool isScene, bool dependency, AssetObject assetObject , bool rapidly);
