...
namespace ND.Managers.ResourceMgr.Framework
{
    ...
    public static class GameFrameworkEntry
    {
        ...
        public static T GetModule<T>() where T : class
        {
            ...
            if (!interfaceType.FullName.StartsWith("ND.Managers.ResourceMgr.", StringComparison.Ordinal))
            {
                throw new GameFrameworkException(Utility.Text.Format("You must get a ResourceMgr module, but '{0}' is not.", interfaceType.FullName));
            }
            ...
            if (moduleType == null)
            {
                throw new GameFrameworkException(Utility.Text.Format("Can not find ResourceMgr module type '{0}'.", moduleName));
            }
