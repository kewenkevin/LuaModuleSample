...
//             else
//             {
//                 SceneManager.UnloadSceneAsync(SceneUtility.GetSceneName(sceneAssetName));
//             }
// #else
...
// #endif
        ...
        {
            AsyncOperation asyncOperation = SceneManager.UnloadSceneAsync(SceneUtility.GetSceneName(sceneAssetName));
