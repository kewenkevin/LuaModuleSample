...
using ND.Managers.ResourceMgr.Framework.Event;
...
namespace ND.Managers.ResourceMgr.Runtime
{
    ...
    public sealed class ResourceUpdateFailureEventArgs : GameEventArgs
    {
        ...
        public static ResourceUpdateFailureEventArgs Create(ND.Managers.ResourceMgr.Framework.Resource.ResourceUpdateFailureEventArgs e)
        {
