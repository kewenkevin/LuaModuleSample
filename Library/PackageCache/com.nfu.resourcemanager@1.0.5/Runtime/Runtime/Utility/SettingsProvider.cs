...
namespace ND.Managers.ResourceMgr.Runtime
{
    ...
    /// Runtime, User: persistentDataPath/UserSettings/Packages/PackageName/TypeName.json
    /// </summary>
    internal class SettingsProvider
    {
        ...
        public string GetFilePath()
        {
            ...
            else
            {
                ...
                {
                    if (isProject)
                        filePath = "Assets/GameSettings/NFUSettings/ResourceManager/Resources";
                    else
