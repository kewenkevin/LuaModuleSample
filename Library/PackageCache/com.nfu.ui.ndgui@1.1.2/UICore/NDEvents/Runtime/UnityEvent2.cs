...
namespace ND.UI.NDEvents
{
	...
	[Serializable]
	class PersistentCall2 : ISerializationCallbackReceiver
	{
		[SerializeField]
			...
			if (m_Modes.Count == 1)
			{
				...
				switch (m_Modes[0])
				{
					...
					case PersistentListenerMode2.Void:
						return new InvokableCall2(targetObject, method);
					case PersistentListenerMode2.Object:
						return GetObjectCall(targetObject, method, m_Arguments[0]);
					case PersistentListenerMode2.Int:
						return new CachedInvokableCall2<int>(targetObject, method, m_Arguments[0].intArgument);
					case PersistentListenerMode2.Float:
						return new CachedInvokableCall2<float>(targetObject, method, m_Arguments[0].floatArgument);
					case PersistentListenerMode2.String:
						return new CachedInvokableCall2<string>(targetObject, method, m_Arguments[0].stringArgument);
					case PersistentListenerMode2.Bool:
						return new CachedInvokableCall2<bool>(targetObject, method, m_Arguments[0].boolArgument);
					case PersistentListenerMode2.Enum:
						return new CachedInvokableCall2<int>(targetObject, method, m_Arguments[0].intArgument);
					case PersistentListenerMode2.Vector2:
						return new CachedInvokableCall2<Vector2>(targetObject, method, m_Arguments[0].vector2Argument);
#if UNITY_2017_2_OR_NEWER
					case PersistentListenerMode2.Vector2Int:
						return new CachedInvokableCall2<Vector2Int>(targetObject, method, m_Arguments[0].vector2IntArgument);
#endif
					case PersistentListenerMode2.Vector3:
						return new CachedInvokableCall2<Vector3>(targetObject, method, m_Arguments[0].vector3Argument);
#if UNITY_2017_2_OR_NEWER
					case PersistentListenerMode2.Vector3Int:
						return new CachedInvokableCall2<Vector3Int>(targetObject, method, m_Arguments[0].vector3IntArgument);
#endif
					case PersistentListenerMode2.Vector4:
						return new CachedInvokableCall2<Vector4>(targetObject, method, m_Arguments[0].vector4Argument);
					case PersistentListenerMode2.LayerMask:
						return new CachedInvokableCall2<LayerMask>(targetObject, method, m_Arguments[0].layerMaskArgument);
					case PersistentListenerMode2.Color:
						return new CachedInvokableCall2<Color>(targetObject, method, m_Arguments[0].colorArgument);
					default:
						return null;
				}
			}
		...
		private static BaseInvokableCall2 GetObjectCall(Object target, MethodInfo method, ArgumentCache2 arguments)
		{
            ...
            var generic = typeof(CachedInvokableCall2<>);
            ...
            return ci.Invoke(new object[] {target, method, castedObject}) as BaseInvokableCall2;
		}
	...
	class PersistentCallGroup2
	{
		...
		public void RegisterEnumPersistentListener(int index, Object targetObj, Type targetObjType, Enum argument, string methodName)
		{
			PersistentCall2 listener = GetListener(index);
			listener.RegisterPersistentListener(targetObj, targetObjType, methodName);
		...
		public void RegisterVector2PersistentListener(int index, Object targetObj, Type targetObjType, Vector2 argument, string methodName)
		{
			PersistentCall2 listener = GetListener(index);
			listener.RegisterPersistentListener(targetObj, targetObjType, methodName);
...
#if UNITY_2017_2_OR_NEWER
		public void RegisterVector2IntPersistentListener(int index, Object targetObj, Type targetObjType, Vector2Int argument, string methodName)
		{
			PersistentCall2 listener = GetListener(index);
			listener.RegisterPersistentListener(targetObj, targetObjType, methodName);
		...
		public void RegisterVector3PersistentListener(int index, Object targetObj, Type targetObjType, Vector3 argument, string methodName)
		{
			PersistentCall2 listener = GetListener(index);
			listener.RegisterPersistentListener(targetObj, targetObjType, methodName);
...
#if UNITY_2017_2_OR_NEWER
		public void RegisterVector3IntPersistentListener(int index, Object targetObj, Type targetObjType, Vector3Int argument, string methodName)
		{
			PersistentCall2 listener = GetListener(index);
			listener.RegisterPersistentListener(targetObj, targetObjType, methodName);
		...
		public void RegisterVector4PersistentListener(int index, Object targetObj, Type targetObjType, Vector4 argument, string methodName)
		{
			PersistentCall2 listener = GetListener(index);
			listener.RegisterPersistentListener(targetObj, targetObjType, methodName);
		...
		public void RegisterLayerMaskPersistentListener(int index, Object targetObj, Type targetObjType, LayerMask argument, string methodName)
		{
			PersistentCall2 listener = GetListener(index);
			listener.RegisterPersistentListener(targetObj, targetObjType, methodName);
	...
	public abstract class UnityEventBase2 : ISerializationCallbackReceiver
	{
		...
		protected MethodInfo FindMethod_Impl(object targetObj, string name)
        {
            return FindMethod_Impl(targetObj.GetType(), name);
        }

		protected abstract MethodInfo FindMethod_Impl(Type targetObjType, string name);
		...
		internal MethodInfo FindMethod(Type listenerType,string name,  PersistentListenerMode2 mode, Type argumentType)
		{
			switch (mode)
			{
				case PersistentListenerMode2.EventDefined:
					return FindMethod_Impl(listenerType, name);
				case PersistentListenerMode2.Void:
					return GetValidMethodInfo(listenerType, name, new Type[0]);
				case PersistentListenerMode2.Object:
					return GetValidMethodInfo(listenerType, name, new Type[1] { argumentType ?? typeof(Object) });
				case PersistentListenerMode2.Int:
					return GetValidMethodInfo(listenerType, name, new Type[1] { typeof(int) });
				case PersistentListenerMode2.Float:
					return GetValidMethodInfo(listenerType, name, new Type[1] { typeof(float) });
				case PersistentListenerMode2.String:
					return GetValidMethodInfo(listenerType, name, new Type[1] { typeof(string) });
				case PersistentListenerMode2.Bool:
					return GetValidMethodInfo(listenerType, name, new Type[1] { typeof(bool) });
				case PersistentListenerMode2.Enum:
					return GetValidMethodInfo(listenerType, name, new Type[1] { typeof(Enum) });
				default:
					return null;
			}
		}
		...
		{
			return m_Calls.GetRuntimeListenerCount();
		}
        ...
        {
			for (Type type = objectType; type != typeof(object) && type != null; type = type.BaseType)
			{
		...
		protected bool ValidateRegistration(MethodInfo method, object targetObj, PersistentListenerMode2 mode, Type argumentType)
        {
            ...
            if (FindMethod(targetType, method.Name, mode, argumentType) == null)
            {
		...
		internal void RegisterEnumPersistentListener(int index, UnityAction<Enum> call, Enum argument)
		{
			...
			m_PersistentCalls.RegisterEnumPersistentListener(index, call.Target as Object, call.Method.DeclaringType, argument, call.Method.Name);
			DirtyPersistentCalls();
		...
		internal void RegisterObjectPersistentListener<T>(int index, UnityAction<T> call, T argument) where T : Object
		{
            ...
            if (!ValidateRegistration(call.Method, call.Target, PersistentListenerMode2.Object, argument == null ? typeof(Object) : argument.GetType()))
                return;
		...
		internal void RegisterVector2PersistentListener(int index, UnityAction<Vector2> call, Vector2 argument)
		{
			...
			m_PersistentCalls.RegisterVector2PersistentListener(index, call.Target as Object, call.Method.DeclaringType, argument, call.Method.Name);
			DirtyPersistentCalls();
		}
#if UNITY_2017_2_OR_NEWER
		...
		internal void RegisterVector3PersistentListener(int index, UnityAction<Vector3> call, Vector3 argument)
		{
			...
			if (!ValidateRegistration(call.Method, call.Target, PersistentListenerMode2.Bool))
				return;
			m_PersistentCalls.RegisterVector3PersistentListener(index, call.Target as Object, call.Method.DeclaringType, argument, call.Method.Name);
			DirtyPersistentCalls();
		}
#if UNITY_2017_2_OR_NEWER
		...
		internal void RegisterVector3IntPersistentListener(int index, UnityAction<Vector3Int> call, Vector3Int argument)
		{
			...
			if (!ValidateRegistration(call.Method, call.Target, PersistentListenerMode2.Bool))
				return;
			m_PersistentCalls.RegisterVector3IntPersistentListener(index, call.Target as Object, call.Method.DeclaringType, argument, call.Method.Name);
			DirtyPersistentCalls();
		}
#endif
		...
		internal void RegisterVector4PersistentListener(int index, UnityAction<Vector4> call, Vector4 argument)
		{
			...
			if (!ValidateRegistration(call.Method, call.Target, PersistentListenerMode2.Bool))
				return;
			m_PersistentCalls.RegisterVector4PersistentListener(index, call.Target as Object, call.Method.DeclaringType, argument, call.Method.Name);
			DirtyPersistentCalls();
		}
	}
}