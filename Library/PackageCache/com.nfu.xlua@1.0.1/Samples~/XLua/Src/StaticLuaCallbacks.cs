...
namespace XLua
{
    ...
    public partial class StaticLuaCallbacks
    {
        ...
        internal static int Print(RealStatePtr L)
        {
            try
            {
                ...
                for (int i = 1; i <= n; i++)
                {
                    ...
                    if (i == 1 && n > 1)
                    {
                        logType = LuaAPI.lua_tostring(L, -1);
                    }
                    else
                    {
                ...
                if (LuaEnv.logHandler != null)
                {
                    LuaEnv.logHandler(s, logType);
                }
                else
                {
        ...
        [MonoPInvokeCallback(typeof(LuaCSFunction))]
        internal static int Warn(RealStatePtr L)
        {
            try
            {
                int n = LuaAPI.lua_gettop(L);
                ...
                if (LuaEnv.warnHandler != null)
                {
                    LuaEnv.warnHandler(s, logType);
                }
                else
                {
                    UnityEngine.Debug.Log("LUA: " + s);
        ...
        [MonoPInvokeCallback(typeof(LuaCSFunction))]
        internal static int LogError(RealStatePtr L)
        {
            try
            {
                int n = LuaAPI.lua_gettop(L);
                ...
                if (LuaEnv.logErrorHandler != null)
                {
                    LuaEnv.logErrorHandler(s, logType);
                }
                else
                {
                    UnityEngine.Debug.Log("LUA: " + s);
