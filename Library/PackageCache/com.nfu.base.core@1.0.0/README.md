...
<root>
  ...
  ├── Editor
  │   ├── Vikingsc2007.BaseDebugKit.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Vikingsc2007.BaseDebugKit.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Vikingsc2007.BaseDebugKit.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Vikingsc2007.BaseDebugKit.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Vikingsc2007.BaseDebugKit`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package [Base] Debug Kit Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Vikingsc2007.BaseDebugKit.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Vikingsc2007.BaseDebugKit.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Vikingsc2007.BaseDebugKit.Editor.Tests.asmdef`

  `Tests/Runtime/Vikingsc2007.BaseDebugKit.Tests.asmdef`
...
Use the `Documentations~/[Base] Debug Kit.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
