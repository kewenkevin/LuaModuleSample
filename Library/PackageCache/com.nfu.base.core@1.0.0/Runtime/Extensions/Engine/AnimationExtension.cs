...
// 
//     File Name           :        AnimationExtension.cs
// 
...
namespace ND.Core.Extensions.Engine
{
    ...
    {
        public static float GetClipTime(this Animation animation, string clipName, float defaultTime = 1)
        {
            var aniState = animation[clipName];
            if (aniState != null)
